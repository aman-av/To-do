...
const file_proto_todo_proto_rawDesc = "" +
	"\n" +
	"\x10proto/todo.proto\x12\x04todo\"N\n" +
	"\x04Task\x12\x0e\n" +
	...
	".todo.Task\x122\n" +
	"\n" +
	"DeleteTask\x12\x17.todo.DeleteTaskRequest\x1a\v.todo.EmptyB\x0eZ\f./proto;todob\x06proto3"
...
var file_proto_todo_proto_depIdxs = []int32{
	...
	6, // 3: todo.TodoService.ListTasks:input_type -> todo.Empty
